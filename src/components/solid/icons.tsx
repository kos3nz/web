...
export function Check(props: ComponentProps<"svg">) {
  return (
    ...
    >
      <path class="check-icon" d="M5 13l4 4L19 7" />
    </svg>
  )
}
...
export function Mail(props: ComponentProps<"svg">) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
function React(props: ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 32 32"
      fill="currentColor"
...
function Typescript(props: ComponentProps<"svg">) {
  return (
    <svg
      stroke="currentColor"
      fill="currentColor"
...
function Nextjs(props: ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 25 24"
      stroke="currentColor"
