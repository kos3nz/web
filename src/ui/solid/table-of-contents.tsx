...
export default function TableOfContents(props: {
  ...
  return (
    <div class="max-w-xs rounded-xl border border-slate-400/20 p-6 md:border-0">
      <span class="block text-xs font-bold uppercase text-slate-300">On this page</span>
      <ol class="mt-3 border-l-2 border-slate-400/20 text-xs font-semibold">
