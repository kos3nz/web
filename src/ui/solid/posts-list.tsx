...
import PostCard from "@/ui/solid/post-card.tsx"
      ...
      <For each={filtered()}>
        {(post) => (
          <div class="relative">
            ...
            {/* Dot */}
            <span class="absolute left-[-2.25px] top-[10px] hidden size-1.5 rounded-full border-[1.5px] border-slate-600 bg-slate-900 transition-colors duration-500 peer-hover:border-cyan-500 peer-hover:bg-cyan-500 md:block" />
          </div>
        )}
      </For>
    </div>
